...
var o35072 = temp__5733__auto__;
var temp__5733__auto____$1 = (o35072["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o35073 = temp__5733__auto____$1;
return (o35073["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__33285__auto__ = f;
return (o__33285__auto__["toString"]).call(o__33285__auto__);
} else {
return "";
}
}catch (e35074){var _ = e35074;
return "";
}});
...
try{var o__33285__auto___35205 = t;
(o__33285__auto___35205["cljs$lang$ctorPrWriter"]).call(o__33285__auto___35205,t,writer);
}catch (e35075){var __35206 = e35075;
}
...
var char_code = (function (){var o__33285__auto__ = (new String(char$));
return (o__33285__auto__["charCodeAt"]).call(o__33285__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__33285__auto__ = String;
return (o__33285__auto__["fromCharCode"]).call(o__33285__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__35080 = num_code;
switch (G__35080) {
case (1):
return (185);
...
var o__33285__auto__ = String;
return (o__33285__auto__["fromCharCode"]).call(o__33285__auto__,superscript_code);
});
/**
...
}catch (e35086){var _e__33313__auto__ = e35086;
return false;
}})())){
...
var vec__35088 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35088,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o35097 = temp__5733__auto__;
var temp__5733__auto____$1 = (o35097["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o35098 = temp__5733__auto____$1;
return (o35098["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__35103){
var vec__35104 = p__35103;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35104,(0),null);
...
var G__35237 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__35238 = cljs.core.butlast(remaining_tokens);
name_tokens = G__35237;
remaining_tokens = G__35238;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq35101){
...
var vec__35112 = cljs.core.split_with((function (p1__35111_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__35111_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35112,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35112,(1),null);
...
var vec__35120 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35120,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35120,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__35245 = cljs.core.rest(remaining_tokens);
var G__35246 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__35245;
name_tokens = G__35246;
continue;
} else {
...
var vec__35126 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35126,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35126,(1),null);
var vec__35129 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35129,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35129,(1),null);
var vec__35132 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35132,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35132,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35132,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35132,(3),null);
...
var vec__35137 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35137,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35137,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35137,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35137,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35137,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35137,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__35140 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35140,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35140,(1),null);
var vec__35144 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35144,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35144,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__35150 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__35150) : devtools.munging.parse_fn_info_deep.call(null,G__35150));
})()));
}
} else {
return fn_info;
...
var G__35279 = (arity + (1));
var G__35280 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__35157){
var vec__35158 = p__35157;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35158,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35158,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35162_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__35162_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35163_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__35163_SHARP_);
}),sorted_infos);
...
args__4795__auto__.push((arguments[i__4790__auto___35289]));

var G__35292 = (i__4790__auto___35289 + (1));
i__4790__auto___35289 = G__35292;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__35169){
var vec__35170 = p__35169;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35170,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq35164){
var G__35165 = cljs.core.first(seq35164);
var seq35164__$1 = cljs.core.next(seq35164);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35165,seq35164__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35179__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35179__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35179__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35179__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__35180 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35180,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35180,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35180,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35180,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35180,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35180,(5),null);
...
var o__33285__auto__ = f;
return (o__33285__auto__["getBasis"]).call(o__33285__auto__);
});
/**
...
}catch (e35184){var _e__33313__auto__ = e35184;
...
var G__35307 = (obj[cljs.core.first(path)]);
var G__35308 = cljs.core.rest(path);
obj = G__35307;
path = G__35308;
continue;
} else {
...
var _STAR_ = (function (accum,p__35190){
var vec__35191 = p__35190;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35191,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35191,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__35196){
var vec__35197 = p__35196;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35197,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35197,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35197,(2),null);
...
var post_process = (function (p__35201){
var vec__35202 = p__35201;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35202,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35202,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35200_SHARP_){
return (obj[cljs.core.first(p1__35200_SHARP_)]);
}),sorted_matches);
