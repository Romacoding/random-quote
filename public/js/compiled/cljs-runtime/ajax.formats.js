...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__44385){
var map__44386 = p__44385;
var map__44386__$1 = (((((!((map__44386 == null))))?(((((map__44386.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44386.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__44386):map__44386);
var request = map__44386__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44386__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__44390 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__44390.cljs$core$IFn$_invoke$arity$1 ? fexpr__44390.cljs$core$IFn$_invoke$arity$1(response) : fexpr__44390.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__44391 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__44391.cljs$core$IFn$_invoke$arity$1 ? fexpr__44391.cljs$core$IFn$_invoke$arity$1(response) : fexpr__44391.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__44392){
...
var request = map__44393__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44393__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
