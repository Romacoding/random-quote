...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k43210,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k43210,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__43241){
var vec__43242 = p__43241;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43242,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43242,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__43209){
var self__ = this;
var G__43209__$1 = this;
return (new cljs.core.RecordIter((0),G__43209__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__43245 = (function (coll__4436__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__43245(this__4435__auto____$1);
})();
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this43211,other43212){
var self__ = this;
var this43211__$1 = this;
return (((!((other43212 == null)))) && ((this43211__$1.constructor === other43212.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43211__$1.status,other43212.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43211__$1.body,other43212.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43211__$1.status_text,other43212.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43211__$1.headers,other43212.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43211__$1.was_aborted,other43212.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43211__$1.__extmap,other43212.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__43209){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__43246 = cljs.core.keyword_identical_QMARK_;
var expr__43247 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__43249 = new cljs.core.Keyword(null,"status","status",-1997798413);
var G__43250 = expr__43247;
return (pred__43246.cljs$core$IFn$_invoke$arity$2 ? pred__43246.cljs$core$IFn$_invoke$arity$2(G__43249,G__43250) : pred__43246.call(null,G__43249,G__43250));
})())){
return (new ajax.protocols.Response(G__43209,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__43251 = new cljs.core.Keyword(null,"body","body",-2049205669);
var G__43252 = expr__43247;
return (pred__43246.cljs$core$IFn$_invoke$arity$2 ? pred__43246.cljs$core$IFn$_invoke$arity$2(G__43251,G__43252) : pred__43246.call(null,G__43251,G__43252));
})())){
return (new ajax.protocols.Response(self__.status,G__43209,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__43253 = new cljs.core.Keyword(null,"status-text","status-text",-1834235478);
var G__43254 = expr__43247;
return (pred__43246.cljs$core$IFn$_invoke$arity$2 ? pred__43246.cljs$core$IFn$_invoke$arity$2(G__43253,G__43254) : pred__43246.call(null,G__43253,G__43254));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__43209,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__43255 = new cljs.core.Keyword(null,"headers","headers",-835030129);
var G__43256 = expr__43247;
return (pred__43246.cljs$core$IFn$_invoke$arity$2 ? pred__43246.cljs$core$IFn$_invoke$arity$2(G__43255,G__43256) : pred__43246.call(null,G__43255,G__43256));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__43209,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__43257 = new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828);
var G__43258 = expr__43247;
return (pred__43246.cljs$core$IFn$_invoke$arity$2 ? pred__43246.cljs$core$IFn$_invoke$arity$2(G__43257,G__43258) : pred__43246.call(null,G__43257,G__43258));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__43209,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__43209),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__43209){
var self__ = this;
var this__4438__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__43209,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__43213){
var extmap__4478__auto__ = (function (){var G__43265 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__43213,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__43213)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__43265);
} else {
return G__43265;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__43213),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__43213),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__43213),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__43213),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__43213),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
