...
var vec__44688 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__44690;
var parts = seq__44689__$1;
...
var self__ = this;
var self__ = this;
var G__44704 = (arguments.length - (1));
switch (G__44704) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args44702){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args44702)));
}));
...
var _STAR_always_update_STAR__orig_val__44727 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__44728 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__44728);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__44727);
}} else {
